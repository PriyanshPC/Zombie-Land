...
namespace ZombieLand.Managers
{
    public class EnemyManager
    {
        ...
        {
        content.Load<Texture2D>("Zombie/Enemy_1"),
        content.Load<Texture2D>("Zombie/Enemy_2"),
        };
        ...
        public Enemy GetEnemy()
        {
            ...
            return new Enemy(texture)
            {
                ...
                Health = 5,
                Layer = 0.2f,
                Position = new Vector2(Game1.ScreenWidth + texture.Width, Game1.Random.Next(0, Game1.ScreenHeight-100)),
