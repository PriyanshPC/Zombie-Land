...
namespace ZombieLand.Sprites
{
    public class Player : Vehicle
    {
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            Position = Vector2.Clamp(Position, new Vector2(100, 350), new Vector2(Game1.ScreenWidth / 2, Game1.ScreenHeight-100));
        }
        ...
        public override void OnCollide(Sprite sprite)
        {
            ...
            if (sprite is Scum && ((Scum)sprite).Parent is Enemy)
                Health--;
